...
public class AccionSemanticaError4 implements AccionSemantica {
    ...
    public Token ejecutar(char simbolo, StringBuilder lexema, ControlPosicion posicionLectura, int lineaCodigo) {
        ...
        lexema.append(".D");
        System.err.println("Warning Léxico: Se esperaba '.' luego de '" + lexema.substring(0, lexema.length() - 2) + "', pero no se encontró en la línea " + lineaCodigo + ". Se asume que se quiso escribir '" + lexema.toString() + "'");
        return null;
    }
