...
public class AccionSemanticaError4 implements AccionSemantica {
    ...
    public Token ejecutar(char simbolo, StringBuilder lexema, ControlPosicion posicionLectura, int lineaCodigoActual) {
        ...
        lexema.append(".D");
        System.err.println("Linea " + lineaCodigoActual + ". Warning Lexico: Se esperaba '.' luego de '" + lexema.substring(0, lexema.length() - 2) + "', pero no se encontro. Se asume que se quiso escribir '" + lexema.toString() + "'");
        return null;
    }
