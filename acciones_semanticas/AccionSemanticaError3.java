...
public class AccionSemanticaError3 implements AccionSemantica {
    ...
    public Token ejecutar(char simbolo, StringBuilder lexema, ControlPosicion posicionLectura, int lineaCodigoActual) {
        ...
        System.out.println("Linea " + lineaCodigoActual + ". Warning Lexico: Se esperaba 'I' luego de la constante numerica '" + lexema.toString() + "', pero no se encontro. Se asume que se quiso escribir '" + lexema.toString() + "I'");
