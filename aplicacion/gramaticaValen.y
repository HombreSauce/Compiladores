...
programa    : ID LLAVEINIC bloque LLAVEFIN

/* ========= Bloques ========= */ /* Mezcla declarativas + ejecutables */   

bloque	: bloque sentencia_programa
  		| sentencia_programa
        // | /* vacio */
  		;
...
sentencia_programa  : sentencia_declarativa
...
sentencia_declarativa   : declaracion_variable PUNTOYCOMA { SINT.add(lex.getLineaActual(), "Declaracion de variable"); }
                        | declaracion_funcion { SINT.add(lex.getLineaActual(), "Declaracion de funcion"); }
                        | declaracion_variable error {yyerror("Error sintáctico: falta ';' al final de la declaración de variable");}

// sentencia	: tipo lista_ids PUNTOYCOMA { SINT.add(lex.getLineaActual(), "Declaracion de variable"); }
...
declaracion_variable    : tipo lista_declaracion
                        | lista_declaracion {yyerror("Error sintactico: falta tipo en declaracion de variables");}
                        ;

lista_declaracion   : lista_declaracion COMA ID
                    | ID
                    | lista_declaracion COMA error {yyerror("Error sintactico: falta identificador después de coma");}
                    | lista_declaracion ID {yyerror("Error: falta una coma entre identificadores en la lista de variables");}
                    ;
